...
import com.ywl01.baidu.net.observers.LoginObserver;
...
import static com.ywl01.baidu.R.id.et_password;
import static com.ywl01.baidu.R.id.et_realName;
import static com.ywl01.baidu.R.id.et_userName;
...
public class LoginDialog extends Dialog implements View.OnClickListener, BaseObserver.OnNextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etUserName = (EditText) view.findViewById(et_userName);
        etPassword = (EditText) view.findViewById(et_password);
    ...
    private void showRegisterView() {
        ...
        etUserName_register = (EditText) view.findViewById(et_userName);
        etPassword_register = (EditText) view.findViewById(et_password);
        etRePassword = (EditText) view.findViewById(R.id.et_repass);
        etRealName = (EditText) view.findViewById(et_realName);
        ...
        if (observer == loginObserver) {
            ...
            try {
                ...
                if (arr.length() > 0) {
                    ...
                    SPUtils.put(context,"userID",User.id);
                    SPUtils.put(context,"realName",User.realName);
                    SPUtils.put(context,"userName",User.userName);
